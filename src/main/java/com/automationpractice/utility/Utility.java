...
//*************************** Select Class Methods ***************************************//
    ...
    public void selectMenu(List<WebElement> names, String menu) throws InterruptedException {
...
//************************** Waits Methods *********************************************//
    ...
    public void verifyElements(String expectedMessage, String actualMessage, String displayMessage) {
    ...
    public void verifyTheSortingOrderOfPriceLowToHighIsCorrect(By beforeFilterElements, By dropDown, By lowToHigh) {
        ...
        mouseHoverNoClick(dropDown);
        mouseHoverAndClick(lowToHigh);
